...
{
	mCallbackStateChaged = aCallbackStateChanged;
}

bool ContackSensorManager::IsContactCloased()
{
...
void ContactSensorManager::HandleAction(void * aGenericEvent)
{
	...
	{
		PLAT_LOG("Callback for state change was not set. Please set an appropriate callback":;
	}
}
